...
FrameTrail.defineModule('AdminSettingsDialog', function(FrameTrail){
    ...
    function open() {
        ...
        _cuw.innerHTML = '<div class="configEditingForm layoutRow">'
                            ...
                            +   '        </div>'
                            +   '        <div class="checkboxRow"><label class="switch"><input type="checkbox" name="allowCollaboration" id="allowCollaboration" '+((configData.allowCollaboration && configData.allowCollaboration.toString() == "true") ? "checked" : "")+'><span class="slider round"></span></label><label for="allowCollaboration" data-tooltip-left="'+ labels['MessageUserCollaboration'] +'">'+ labels['SettingsAllowCollaboration'] +'</label></div>'
                            +   '    </div>'
                            +   '    <div class="column-3">'
                            +   '        <div class="checkboxRow"><label class="switch"><input type="checkbox" name="allowUploads" id="allowUploads" '+((configData.allowUploads && configData.allowUploads.toString() == "true") ? "checked" : "")+'><span class="slider round"></span></label><label for="allowUploads" data-tooltip-left="'+ labels['MessageAllowFileUploads'] +'">'+ labels['SettingsAllowUploads'] +'</label></div>'
                            +   '    </div>'
                            +   '    <div class="column-3">'
